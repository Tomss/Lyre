              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative max-w-4xl mx-auto">
                  ...
                  <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-green-400 via-blue-400 to-purple-400 rounded-full" 
                       style={{ height: `${upcomingEvents.length * 300}px` }}>
                    {/* Pulsation en haut */}
                  ...
                  {upcomingEvents.map((event, index) => {
                    ...
                    return (
                      <div key={event.id} className={`relative flex items-center mb-20 ${isLeft ? 'justify-start' : 'justify-end'}`}>
                        {/* Point sur la timeline */}
                        <div className="absolute left-1/2 transform -translate-x-1/2 z-10">
                          <div className="w-6 h-6 bg-white rounded-full border-4 border-blue-400 shadow-lg">
                          ...
                          <div className={`bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group ${
                            ...
                            <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-6 text-white relative overflow-hidden">
                              ...
                              <div className="relative z-10">
                                ...
                                <h3 className="font-poppins font-bold text-2xl mb-2 group-hover:scale-105 transition-transform duration-300">
                                  {event.title}
                                </h3>
