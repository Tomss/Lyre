...
import { X, Image as ImageIcon, Music, FileText, Search, Trash2 } from 'lucide-react';
            ...
            >
              {file.file_type === 'image' ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center p-2">
                  ...
                  {/* Bouton supprimer pour les fichiers non-images */}
                  <button
                    type="button"
                    onClick={() => onRemove(file.id)}
                    className="absolute top-2 right-2 p-1.5 bg-white/90 text-red-500 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-opacity"
                  >
