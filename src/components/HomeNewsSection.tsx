        ...
        <section id="actualites" className="py-24 bg-white relative overflow-hidden scroll-mt-20 group/section">
            ...
            >
                ...
                <button
                    ...
                    className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-50 w-12 h-12 rounded-full bg-white backdrop-blur shadow-xl border border-teal-100 text-teal-600 flex items-center justify-center hover:bg-teal-500 hover:text-white transition-all duration-200 cursor-pointer"
                ...
                <button
                    ...
                    className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-50 w-12 h-12 rounded-full bg-white backdrop-blur shadow-xl border border-teal-100 text-teal-600 flex items-center justify-center hover:bg-teal-500 hover:text-white transition-all duration-200 cursor-pointer"
                    aria-label="Suivant"
                    title="Suivant"
                >
